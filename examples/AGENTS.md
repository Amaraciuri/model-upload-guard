# Agent instructions (Model Upload Guard)

Copy this file into a project root (or paste into Cursor/Claude Code agent rules).
...
5. Never ask the human to paste secrets into chat. Never disable mug safety flags casually (`--allow-findings`, `--force`, `--allow-network`).
